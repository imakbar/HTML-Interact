...
<head>
	...
	<title>Page Coming Soon - 2 | Interact Responsive Template</title>
	...
	<section class="bg-pink pt-s5 pb-s5 text-white">
		<div class="container">
			<div class="text-center mb-s3">
				<a href="index.php">
					<img class="w--80" src="assets/images/logo/icon-light.png" alt="Interact Responsive Template">
				</a>
			</div>
			<h1 class="text-bold-600 text-white text-center">Coming Soon</h1>
			<h5 class="text-bold-300 text-white text-center">Leave your email and we'll let you know once the site goes live.</h5>
			<div class="form-row">
			...
			<div class="text-center mt-s4">
				<ul class="social list-inline text-size-s2">
					<li class="list-inline-item">
						<a class="bg-v4-dark text-white bg-v6-dark--hover text-size-s1 text-white--hover rounded-circle" href="#">
