...
<head>
	...
	<title>Portfolio Grid - 1 Two Column | Interact Responsive Template</title>
				...
				<div class="col-md-12">
					<div class="d-lg-flex text-center">
						<div class="align-self-center mb-0--lg mb-s1--md mb-s1--sm mb-s1--xs">
							<h3 class="text-bold-400 text-size-s2 m-0 text-white">Portfolio Grid - 1 Two Column</h3>
						</div>
						<div class="ml-auto align-self-center">
							<ol class="breadcrumb d-flex justify-content-center m-0 bg-none text-size-s1 p-0">
								...
								<li class="breadcrumb-item" aria-current="page">Portfolio Grid - 1 Two Column</li>
							</ol>
						</div>
					</div>
				</div>
