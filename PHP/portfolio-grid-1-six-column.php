...
<head>
	...
	<title>Portfolio Grid - 1 Six Column | Interact Responsive Template</title>
				...
				<div class="col-md-12">
					<div class="d-lg-flex text-center">
						<div class="align-self-center mb-0--lg mb-s1--md mb-s1--sm mb-s1--xs">
							<h3 class="text-bold-400 text-size-s2 m-0 text-white">Portfolio Grid - 1 Six Column</h3>
						</div>
						<div class="ml-auto align-self-center">
							<ol class="breadcrumb d-flex justify-content-center m-0 bg-none text-size-s1 p-0">
								...
								<li class="breadcrumb-item" aria-current="page">Portfolio Grid - 1 Six Column</li>
							</ol>
						</div>
					</div>
				</div>
					...
					<ul class="row sort-destination" data-sort-id="portfolio">
						<li class="col-xl-2 col-lg-3 col-md-4 isotope-item design">
							<div class="animate-parent--hover mb-s3 hero-section-parent">
								...
								<div class="hero-section-container-tl bg-v7-dark h-100 w-100 d-flex align-items-end justify-content-start p-s1 p-s3--xs p-s3--sm p-s2--md animate-bounceIn-child--hover">
									<div>
										<h2 class="text-size-18 text-bold-600"><a class="text-white" href="#">Portfolio 1</a></h2>
										<div class="hero-section-container-tr p-s1 p-s3--xs p-s3--sm p-s2--md d-xl-none">
