...
<head>
	...
	<title>Portfolio Classic - 2 Full Width | Interact Responsive Template</title>
				...
				<div class="col-md-12">
					<div class="d-lg-flex text-center">
						<div class="align-self-center mb-0--lg mb-s1--md mb-s1--sm mb-s1--xs">
							<h3 class="text-bold-400 text-size-s2 m-0 text-white">Portfolio Classic - 2 Full Width</h3>
						</div>
						<div class="ml-auto align-self-center">
							<ol class="breadcrumb d-flex justify-content-center m-0 bg-none text-size-s1 p-0">
								...
								<li class="breadcrumb-item" aria-current="page">Portfolio Classic - 2 Full Width</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="col-md-12">
					<ul class="row sort-destination" data-sort-id="portfolio">
						...
						<li class="col-xl-2 col-lg-3 col-md-4 isotope-item branding photography">
							<div class="owl-carousel owl-theme owl-nav-bg show-nav-hover owl-dots-inside-top-left" data-plugin-options="{'responsive': {'0': {'items': 1}, '479': {'items': 1}, '768': {'items': 1}, '979': {'items': 1}, '1199': {'items': 1}}, 'margin': 10, 'loop': true, 'nav': true, 'dots': true, 'animateOut': 'fadeOut', 'autoplay': false, 'autoplayTimeout': 3000}">
								<div>
									<div class="bg-dark bg-parent--hover mb-s3 text-parent--hover bc-parent--hover">
										<div class="p-s1 p-s3--xs p-s3--sm p-s2--md bg-pink-child">
											<a href="#"><img class="img-responsive box-shadow-v3-s2" src="assets/images/portfolio/2-720x435.jpg" alt="Portfolio"/></a>
										</div>
										<div class="p-s2 p-s3--xs p-s3--sm p-s2--md bg-pink-child">
											...
											<ul class="d-inline-block text-size-12 text-v5-white">
												<li class="list-inline-item pr-s1">
													<a href="assets/images/portfolio/2-720x435.jpg" data-fancybox class="text-v5-white text-white--hover"><i class="fa fa-eye"></i></a>
												</li>
												<li class="list-inline-item pr-s1">
													<a href="#" class="text-v5-white text-white--hover"><i class="fa fa-link"></i></a>
												</li>
								...
								<div>
									<div class="bg-dark bg-parent--hover mb-s3 text-parent--hover bc-parent--hover">
										<div class="p-s1 p-s3--xs p-s3--sm p-s2--md bg-pink-child">
											<a href="#"><img class="img-responsive box-shadow-v3-s2" src="assets/images/portfolio/5-720x435.jpg" alt="Portfolio"/></a>
										</div>
										<div class="p-s2 p-s3--xs p-s3--sm p-s2--md bg-pink-child">
											<h2 class="text-size-18 text-bold-600"><a class="text-white" href="#">Portfolio 2</a></h2>
											<ul class="list-inline text-size-12 text-v5-white mt-s1 mb-s1">
											...
											<ul class="d-inline-block text-size-12 text-v5-white">
												<li class="list-inline-item pr-s1">
													<a href="assets/images/portfolio/5-720x435.jpg" data-fancybox class="text-v5-white text-white--hover"><i class="fa fa-eye"></i></a>
												</li>
												<li class="list-inline-item pr-s1">
													<a href="#" class="text-v5-white text-white--hover"><i class="fa fa-link"></i></a>
												</li>
								...
								<div>
									<div class="bg-dark bg-parent--hover mb-s3 text-parent--hover bc-parent--hover">
										<div class="p-s1 p-s3--xs p-s3--sm p-s2--md bg-pink-child">
											<a href="#"><img class="img-responsive box-shadow-v3-s2" src="assets/images/portfolio/6-720x435.jpg" alt="Portfolio"/></a>
										</div>
										<div class="p-s2 p-s3--xs p-s3--sm p-s2--md bg-pink-child">
											<h2 class="text-size-18 text-bold-600"><a class="text-white" href="#">Portfolio 2</a></h2>
											<ul class="list-inline text-size-12 text-v5-white mt-s1 mb-s1">
											...
											<ul class="d-inline-block text-size-12 text-v5-white">
												<li class="list-inline-item pr-s1">
													<a href="assets/images/portfolio/6-720x435.jpg" data-fancybox class="text-v5-white text-white--hover"><i class="fa fa-eye"></i></a>
												</li>
												<li class="list-inline-item pr-s1">
													<a href="#" class="text-v5-white text-white--hover"><i class="fa fa-link"></i></a>
												</li>
						...
						<li class="col-xl-2 col-lg-3 col-md-4 isotope-item studio">
							<div class="bg-dark bg-parent--hover mb-s3 text-parent--hover bc-parent--hover">
								<div class="p-s1 p-s3--xs p-s3--sm p-s2--md bg-pink-child">
									<a href="#"><img class="img-responsive box-shadow-v3-s2" src="assets/images/portfolio/3-720x435.jpg" alt="Portfolio"/></a>
								</div>
								<div class="p-s2 p-s3--xs p-s3--sm p-s2--md bg-pink-child">
									...
									<ul class="d-inline-block text-size-12 text-v5-white">
										<li class="list-inline-item pr-s1">
											<a href="assets/images/portfolio/3-720x435.jpg" data-fancybox class="text-v5-white text-white--hover"><i class="fa fa-eye"></i></a>
										</li>
										<li class="list-inline-item pr-s1">
											<a href="#" class="text-v5-white text-white--hover"><i class="fa fa-link"></i></a>
										</li>
						...
						<li class="col-xl-2 col-lg-3 col-md-4 isotope-item design">
							<div class="bg-dark bg-parent--hover mb-s3 text-parent--hover bc-parent--hover">
								<div class="p-s1 p-s3--xs p-s3--sm p-s2--md bg-pink-child">
									<a href="#"><img class="img-responsive box-shadow-v3-s2" src="assets/images/portfolio/4-720x435.jpg" alt="Portfolio"/></a>
								</div>
								<div class="p-s2 p-s3--xs p-s3--sm p-s2--md bg-pink-child">
									...
									<ul class="d-inline-block text-size-12 text-v5-white">
										<li class="list-inline-item pr-s1">
											<a href="assets/images/portfolio/4-720x435.jpg" data-fancybox class="text-v5-white text-white--hover"><i class="fa fa-eye"></i></a>
										</li>
										<li class="list-inline-item pr-s1">
											<a href="#" class="text-v5-white text-white--hover"><i class="fa fa-link"></i></a>
										</li>
						...
						<li class="col-xl-2 col-lg-3 col-md-4 isotope-item design">
							<div class="bg-dark bg-parent--hover mb-s3 text-parent--hover bc-parent--hover">
								<div class="p-s1 p-s3--xs p-s3--sm p-s2--md bg-pink-child">
									<a href="#"><img class="img-responsive box-shadow-v3-s2" src="assets/images/portfolio/7-720x435.jpg" alt="Portfolio"/></a>
								</div>
								<div class="p-s2 p-s3--xs p-s3--sm p-s2--md bg-pink-child">
									...
									<ul class="d-inline-block text-size-12 text-v5-white">
										<li class="list-inline-item pr-s1">
											<a href="assets/images/portfolio/7-720x435.jpg" data-fancybox class="text-v5-white text-white--hover"><i class="fa fa-eye"></i></a>
										</li>
										<li class="list-inline-item pr-s1">
											<a href="#" class="text-v5-white text-white--hover"><i class="fa fa-link"></i></a>
										</li>
						...
						<li class="col-xl-2 col-lg-3 col-md-4 isotope-item branding photography">
							<div class="bg-dark bg-parent--hover mb-s3 text-parent--hover bc-parent--hover">
								<div class="p-s1 p-s3--xs p-s3--sm p-s2--md bg-pink-child">
									<a href="#"><img class="img-responsive box-shadow-v3-s2" src="assets/images/portfolio/8-720x435.jpg" alt="Portfolio"/></a>
								</div>
								<div class="p-s2 p-s3--xs p-s3--sm p-s2--md bg-pink-child">
									...
									<ul class="d-inline-block text-size-12 text-v5-white">
										<li class="list-inline-item pr-s1">
											<a href="assets/images/portfolio/8-720x435.jpg" data-fancybox class="text-v5-white text-white--hover"><i class="fa fa-eye"></i></a>
										</li>
										<li class="list-inline-item pr-s1">
											<a href="#" class="text-v5-white text-white--hover"><i class="fa fa-link"></i></a>
										</li>
						...
						<li class="col-xl-2 col-lg-3 col-md-4 isotope-item studio">
							<div class="bg-dark bg-parent--hover mb-s3 text-parent--hover bc-parent--hover">
								<div class="p-s1 p-s3--xs p-s3--sm p-s2--md bg-pink-child">
									<a href="#"><img class="img-responsive box-shadow-v3-s2" src="assets/images/portfolio/9-720x435.jpg" alt="Portfolio"/></a>
								</div>
								<div class="p-s2 p-s3--xs p-s3--sm p-s2--md bg-pink-child">
									...
									<ul class="d-inline-block text-size-12 text-v5-white">
										<li class="list-inline-item pr-s1">
											<a href="assets/images/portfolio/9-720x435.jpg" data-fancybox class="text-v5-white text-white--hover"><i class="fa fa-eye"></i></a>
										</li>
										<li class="list-inline-item pr-s1">
											<a href="#" class="text-v5-white text-white--hover"><i class="fa fa-link"></i></a>
										</li>
