...
<head>
	...
	<title>Portfolio Grid - 2 Full Width | Interact Responsive Template</title>
				...
				<div class="col-md-12">
					<div class="d-lg-flex text-center">
						<div class="align-self-center mb-0--lg mb-s1--md mb-s1--sm mb-s1--xs">
							<h3 class="text-bold-400 text-size-s2 m-0 text-white">Portfolio Grid - 2 Full Width</h3>
						</div>
						<div class="ml-auto align-self-center">
							<ol class="breadcrumb d-flex justify-content-center m-0 bg-none text-size-s1 p-0">
								...
								<li class="breadcrumb-item" aria-current="page">Portfolio Grid - 2 Full Width</li>
							</ol>
						</div>
					</div>
				</div>
								...
								<div class="hero-section-container-tl bg-white h-100 w-100 d-flex align-items-center justify-content-center p-s1 p-s3--xs p-s3--sm p-s2--md text-center animate-jello-child--hover">
									<div>
										...
										<ul class="social list-inline text-center text-size-s1 mt-12 d-xl-none">
											<li class="list-inline-item">
												<a href="assets/images/portfolio/1-720x435.jpg" data-fancybox="portfolio2" class="bg-pink--hover text-white--hover text-dark rounded-circle"><i class="fa fa-eye"></i></a>
											</li>
											<li class="list-inline-item">
									...
									<div class="animate-parent--hover mb-s3 hero-section-parent box-shadow-v1-s3--hover">
										...
										<div class="hero-section-container-tl bg-white h-100 w-100 d-flex align-items-center justify-content-center p-s1 p-s3--xs p-s3--sm p-s2--md text-center animate-jello-child--hover">
											<div>
												...
												<ul class="social list-inline text-center text-size-s1 mt-12 d-xl-none">
													<li class="list-inline-item">
														<a href="assets/images/portfolio/2-720x435.jpg" data-fancybox="portfolio2" class="bg-pink--hover text-white--hover text-dark rounded-circle"><i class="fa fa-eye"></i></a>
													</li>
													<li class="list-inline-item">
														<a href="#" class="bg-pink--hover text-white--hover text-dark rounded-circle"><i class="fa fa-link"></i></a>
													</li>
									...
									<div class="animate-parent--hover mb-s3 hero-section-parent box-shadow-v1-s3--hover">
										...
										<div class="hero-section-container-tl bg-white h-100 w-100 d-flex align-items-center justify-content-center p-s1 p-s3--xs p-s3--sm p-s2--md text-center animate-jello-child--hover">
											<div>
												...
												<ul class="social list-inline text-center text-size-s1 mt-12 d-xl-none">
													<li class="list-inline-item">
														<a href="assets/images/portfolio/5-720x435.jpg" data-fancybox="portfolio2" class="bg-pink--hover text-white--hover text-dark rounded-circle"><i class="fa fa-eye"></i></a>
													</li>
													<li class="list-inline-item">
														<a href="#" class="bg-pink--hover text-white--hover text-dark rounded-circle"><i class="fa fa-link"></i></a>
													</li>
									...
									<div class="animate-parent--hover mb-s3 hero-section-parent box-shadow-v1-s3--hover">
										...
										<div class="hero-section-container-tl bg-white h-100 w-100 d-flex align-items-center justify-content-center p-s1 p-s3--xs p-s3--sm p-s2--md text-center animate-jello-child--hover">
											<div>
												...
												<ul class="social list-inline text-center text-size-s1 mt-12 d-xl-none">
													<li class="list-inline-item">
														<a href="assets/images/portfolio/6-720x435.jpg" data-fancybox="portfolio2" class="bg-pink--hover text-white--hover text-dark rounded-circle"><i class="fa fa-eye"></i></a>
													</li>
													<li class="list-inline-item">
														<a href="#" class="bg-pink--hover text-white--hover text-dark rounded-circle"><i class="fa fa-link"></i></a>
													</li>
							...
							<div class="animate-parent--hover mb-s3 hero-section-parent box-shadow-v1-s3--hover">
								...
								<div class="hero-section-container-tl bg-white h-100 w-100 d-flex align-items-center justify-content-center p-s1 p-s3--xs p-s3--sm p-s2--md text-center animate-jello-child--hover">
									<div>
										...
										<ul class="social list-inline text-center text-size-s1 mt-12 d-xl-none">
											<li class="list-inline-item">
												<a href="assets/images/portfolio/3-720x435.jpg" data-fancybox="portfolio2" class="bg-pink--hover text-white--hover text-dark rounded-circle"><i class="fa fa-eye"></i></a>
											</li>
											<li class="list-inline-item">
												<a href="#" class="bg-pink--hover text-white--hover text-dark rounded-circle"><i class="fa fa-link"></i></a>
											</li>
							...
							<div class="animate-parent--hover mb-s3 hero-section-parent box-shadow-v1-s3--hover">
								...
								<div class="hero-section-container-tl bg-white h-100 w-100 d-flex align-items-center justify-content-center p-s1 p-s3--xs p-s3--sm p-s2--md text-center animate-jello-child--hover">
									<div>
										...
										<ul class="social list-inline text-center text-size-s1 mt-12 d-xl-none">
											<li class="list-inline-item">
												<a href="assets/images/portfolio/4-720x435.jpg" data-fancybox="portfolio2" class="bg-pink--hover text-white--hover text-dark rounded-circle"><i class="fa fa-eye"></i></a>
											</li>
											<li class="list-inline-item">
												<a href="#" class="bg-pink--hover text-white--hover text-dark rounded-circle"><i class="fa fa-link"></i></a>
											</li>
							...
							<div class="animate-parent--hover mb-s3 hero-section-parent box-shadow-v1-s3--hover">
								...
								<div class="hero-section-container-tl bg-white h-100 w-100 d-flex align-items-center justify-content-center p-s1 p-s3--xs p-s3--sm p-s2--md text-center animate-jello-child--hover">
									<div>
										...
										<ul class="social list-inline text-center text-size-s1 mt-12 d-xl-none">
											<li class="list-inline-item">
												<a href="assets/images/portfolio/7-720x435.jpg" data-fancybox="portfolio2" class="bg-pink--hover text-white--hover text-dark rounded-circle"><i class="fa fa-eye"></i></a>
											</li>
											<li class="list-inline-item">
												<a href="#" class="bg-pink--hover text-white--hover text-dark rounded-circle"><i class="fa fa-link"></i></a>
											</li>
							...
							<div class="animate-parent--hover mb-s3 hero-section-parent box-shadow-v1-s3--hover">
								...
								<div class="hero-section-container-tl bg-white h-100 w-100 d-flex align-items-center justify-content-center p-s1 p-s3--xs p-s3--sm p-s2--md text-center animate-jello-child--hover">
									<div>
										...
										<ul class="social list-inline text-center text-size-s1 mt-12 d-xl-none">
											<li class="list-inline-item">
												<a href="assets/images/portfolio/8-720x435.jpg" data-fancybox="portfolio2" class="bg-pink--hover text-white--hover text-dark rounded-circle"><i class="fa fa-eye"></i></a>
											</li>
											<li class="list-inline-item">
												<a href="#" class="bg-pink--hover text-white--hover text-dark rounded-circle"><i class="fa fa-link"></i></a>
											</li>
							...
							<div class="animate-parent--hover mb-s3 hero-section-parent box-shadow-v1-s3--hover">
								...
								<div class="hero-section-container-tl bg-white h-100 w-100 d-flex align-items-center justify-content-center p-s1 p-s3--xs p-s3--sm p-s2--md text-center animate-jello-child--hover">
									<div>
										...
										<ul class="social list-inline text-center text-size-s1 mt-12 d-xl-none">
											<li class="list-inline-item">
												<a href="assets/images/portfolio/9-720x435.jpg" data-fancybox="portfolio2" class="bg-pink--hover text-white--hover text-dark rounded-circle"><i class="fa fa-eye"></i></a>
											</li>
											<li class="list-inline-item">
												<a href="#" class="bg-pink--hover text-white--hover text-dark rounded-circle"><i class="fa fa-link"></i></a>
											</li>
